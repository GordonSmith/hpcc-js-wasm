import { instantiate } from "../build/compress.js";

export default async function loadCompress(imports: { env: unknown } = { env: undefined }) {
    // @ts-expect-error - process may not be defined in browser
    const isNodeOrBun = typeof process !== "undefined" && process.versions != null && (process.versions.node != null || process.versions.bun != null);

    const wasmUrl = new URL("../build/compress.wasm", import.meta.url);
