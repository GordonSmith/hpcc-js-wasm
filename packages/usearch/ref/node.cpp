...
Napi::Value exactSearch(Napi::CallbackInfo const &ctx)
{
    ...
    case napi_float64_array:
        quantization = scalar_kind_t::f64_k, bytes_per_scalar = 8;
        break;
    case napi_int8_array:
        quantization = scalar_kind_t::i8_k, bytes_per_scalar = 1;
        break;
    default:
        quantization = scalar_kind_t::f32_k, bytes_per_scalar = 4;
        break;
    }
